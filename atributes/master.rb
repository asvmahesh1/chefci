...
default['jenkins-server']['devops']['username'] 
default['jenkins-server']['welcome123$']['password'] -Sets the password for the administrator user. Default "admin". Only used if the security strategy is "generate"
